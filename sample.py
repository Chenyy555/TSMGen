...
#     if gnn_train and decoder_config['att_num'] ==2 and not hgnn_train:
#         qed_threshold=0.38
    
#     if gnn_train and decoder_config['att_num'] == 1 and not hgnn_train:
#         qed_threshold=0.32
...
if __name__ == '__main__':
    ...
    for i,(gnn_data, hgnn_data) in enumerate(val_loader):
        ...
        if pocket_num<110:
            ...
            time_list.append(float((time.time() - t_pocket_start)))
